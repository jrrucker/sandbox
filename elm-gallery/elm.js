...
var _user$project$Images_Models$Image = F7(
	function (a, b, c, d, e, f, g) {
		return {id: a, description: b, dateAdded: c, thumbnail: d, fullsize: e, download: f, people: g};
	});
var _user$project$Images_Models$Person = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _user$project$Images_Models$ImagesContainerModel = function (a) {
	return {images: a};
};

var _user$project$Messages$OnLoadPeople = function (a) {
	return {ctor: 'OnLoadPeople', _0: a};
};
var _user$project$Messages$OnLoadImages = function (a) {
	return {ctor: 'OnLoadImages', _0: a};
};
var _user$project$Messages$OnLocationChange = function (a) {
	return {ctor: 'OnLocationChange', _0: a};
};

var _user$project$Commands$imageDecoder = A3(
				...
				A3(
					...
					A3(
						...
						A3(
							...
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Images_Models$Image))))))));
var _user$project$Commands$imagesDecoder = A2(
	_elm_lang$core$Json_Decode$field,
	'images',
	_elm_lang$core$Json_Decode$list(_user$project$Commands$imageDecoder));
var _user$project$Commands$personDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'name',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		'id',
		_elm_lang$core$Json_Decode$int,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Images_Models$Person)));
var _user$project$Commands$peopleDecoder = A2(
	_elm_lang$core$Json_Decode$field,
	'people',
	_elm_lang$core$Json_Decode$list(_user$project$Commands$personDecoder));
var _user$project$Commands$loadPeople = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$Messages$OnLoadPeople,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, 'Http://localhost:8000/people.json', _user$project$Commands$peopleDecoder)));
var _user$project$Commands$loadImages = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$Messages$OnLoadImages,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, 'http://localhost:8000/images.json', _user$project$Commands$imagesDecoder)));
var _user$project$Commands$loadData = _elm_lang$core$Platform_Cmd$batch(
	{
		ctor: '::',
		_0: _user$project$Commands$loadImages,
		_1: {
			ctor: '::',
			_0: _user$project$Commands$loadPeople,
			_1: {ctor: '[]'}
		}
	});

var _user$project$Routing$personPath = function (id) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'#/person/',
		_elm_lang$core$Basics$toString(id));
};
var _user$project$Routing$imagePath = function (id) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'#/image/',
		_elm_lang$core$Basics$toString(id));
...
var _user$project$Routing$ImageNotFound = {ctor: 'ImageNotFound'};
var _user$project$Routing$PersonNotFound = {ctor: 'PersonNotFound'};
var _user$project$Routing$PersonRoute = function (a) {
	return {ctor: 'PersonRoute', _0: a};
};
var _user$project$Routing$ImageRoute = function (a) {
	return {ctor: 'ImageRoute', _0: a};
};
...
var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		...
		_1: {
			...
			_0: A2(
				...
				_user$project$Routing$ImageRoute,
				A2(
					_evancz$url_parser$UrlParser_ops['</>'],
					_evancz$url_parser$UrlParser$s('image'),
					_evancz$url_parser$UrlParser$int)),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Routing$PersonRoute,
					A2(
						_evancz$url_parser$UrlParser_ops['</>'],
						_evancz$url_parser$UrlParser$s('person'),
						_evancz$url_parser$UrlParser$int)),
				_1: {ctor: '[]'}
			}
		}
...
var _user$project$Routing$parseLocation = function (location) {
	return A2(
		...
		_user$project$Routing$NotFoundRoute,
		A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Routing$matchers, location));
};

var _user$project$Images_CardView$renderThumbnail = function (image) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$src(image.thumbnail),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$alt(image.description),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$title(image.description),
							_1: {ctor: '[]'}
						}
					}
				},
...
var _user$project$Images_CardView$cardView = function (image) {
	var path = _user$project$Routing$imagePath(image.id);
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('view-image'),
			_1: {
				ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$Images_CardView$renderThumbnail(image),
			_1: {ctor: '[]'}
		});
};

var _user$project$Images_ImageView$renderPerson = function (person) {
	var path = _user$project$Routing$personPath(person.id);
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
...
var _user$project$Images_ImageView$renderPeopleList = function (people) {
	return A2(
		_elm_lang$html$Html$p,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('people'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Images_ImageView$renderPerson, people)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Images_ImageView$renderImageDescription = function (image) {
	return A2(
		_elm_lang$html$Html$p,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(image.description),
			_1: {ctor: '[]'}
		});
};
var _user$project$Images_ImageView$renderImage = function (image) {
	return A2(
		_elm_lang$html$Html$img,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$src(image.fullsize),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$alt(image.description),
				_1: {
...
var _user$project$Images_ImageView$imageView = F2(
	function (image, people) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('image-details'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _user$project$Images_ImageView$renderImage(image),
				_1: {
					ctor: '::',
					_0: _user$project$Images_ImageView$renderImageDescription(image),
					_1: {
						ctor: '::',
						_0: _user$project$Images_ImageView$renderPeopleList(people),
						_1: {ctor: '[]'}
					}
				}
			});
...
var _user$project$Models$initialModel = function (route) {
	return {route: route, allImages: _krisajenkins$remotedata$RemoteData$Loading, allPeople: _krisajenkins$remotedata$RemoteData$Loading};
};
var _user$project$Models$Model = F3(
	function (a, b, c) {
		return {route: a, allImages: b, allPeople: c};
	});
...
var _user$project$View$getImagesOfPerson = F2(
	function (person, images) {
		return A2(
			_elm_lang$core$List$filter,
			function (image) {
				return A2(_elm_lang$core$List$member, person.id, image.people);
			},
			images);
	});
var _user$project$View$getPeople = F2(
...
var _user$project$View$getPerson = F2(
	function (model, id) {
		return A2(
			_krisajenkins$remotedata$RemoteData$map,
...
var _user$project$View$getImage = F2(
	function (model, id) {
		return A2(
			_krisajenkins$remotedata$RemoteData$map,
			_elm_lang$core$List$head,
			A2(
				...
				_elm_lang$core$List$filter(
					function (image) {
						return _elm_lang$core$Native_Utils.eq(image.id, id);
					}),
				model.allImages));
	});
var _user$project$View$notFoundView = function (msg) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$View$personNotFoundView = _user$project$View$notFoundView('Person not found.');
var _user$project$View$imageNotFoundView = _user$project$View$notFoundView('Image not found.');
var _user$project$View$galleryView = function (images) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('gallery'),
			_1: {ctor: '[]'}
		},
		A2(_elm_lang$core$List$map, _user$project$Images_CardView$cardView, images));
};
var _user$project$View$errorView = function (err) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$View$loadingView = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Loading image data... '),
		_1: {ctor: '[]'}
	});
var _user$project$View$remoteDataView = F2(
	function (subview, data) {
		var _p0 = data;
		switch (_p0.ctor) {
			case 'NotAsked':
				return _user$project$View$loadingView;
			case 'Loading':
				return _user$project$View$loadingView;
			case 'Success':
				return subview(_p0._0);
			default:
				return _user$project$View$errorView(_p0._0);
		}
	});
var _user$project$View$page = function (model) {
	...
	switch (_p1.ctor) {
		case 'ImageRoute':
			return A2(
				_user$project$View$remoteDataView,
				function (maybeImage) {
					var _p2 = maybeImage;
					if (_p2.ctor === 'Just') {
						var _p3 = _p2._0;
						return A2(
							_user$project$View$remoteDataView,
							_user$project$Images_ImageView$imageView(_p3),
							A2(_user$project$View$getPeople, model, _p3));
					} else {
						return _user$project$View$imageNotFoundView;
					}
				},
				A2(_user$project$View$getImage, model, _p1._0));
		case 'PersonRoute':
			return A2(
				_user$project$View$remoteDataView,
				function (maybePerson) {
					var _p4 = maybePerson;
					if (_p4.ctor === 'Just') {
						return A2(
							_user$project$View$remoteDataView,
							_user$project$View$galleryView,
							A2(
								_krisajenkins$remotedata$RemoteData$map,
								_user$project$View$getImagesOfPerson(_p4._0),
								model.allImages));
					} else {
						return _user$project$View$personNotFoundView;
					}
				},
				A2(_user$project$View$getPerson, model, _p1._0));
		case 'HomeRoute':
			return A2(_user$project$View$remoteDataView, _user$project$View$galleryView, model.allImages);
		case 'PersonNotFound':
			return _user$project$View$personNotFoundView;
		case 'ImageNotFound':
			return _user$project$View$imageNotFoundView;
		default:
			return _user$project$View$notFoundView('Page not found');
	}
};
...
var _user$project$Main$init = function (location) {
	...
	return {
		...
		_1: _user$project$Commands$loadData
	};
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Messages.Msg":{"args":[],"tags":{"OnLoadPeople":["RemoteData.WebData (List Images.Models.Person)"],"OnLocationChange":["Navigation.Location"],"OnLoadImages":["RemoteData.WebData (List Images.Models.Image)"]}},"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Date.Date":{"args":[],"tags":{"Date":[]}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Success":["a"],"Loading":[],"Failure":["e"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}}},"aliases":{"Images.Models.ImageId":{"args":[],"type":"Int"},"RemoteData.WebData":{"args":["a"],"type":"RemoteData.RemoteData Http.Error a"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Images.Models.PersonId":{"args":[],"type":"Int"},"Images.Models.Image":{"args":[],"type":"{ id : Images.Models.ImageId , description : String , dateAdded : Date.Date , thumbnail : String , fullsize : String , download : String , people : List Images.Models.PersonId }"},"Images.Models.Person":{"args":[],"type":"{ id : Images.Models.PersonId, name : String }"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Messages.Msg"},"versions":{"elm":"0.18.0"}});
}

...
var _user$project$Images_Models$Image = F6(
	function (a, b, c, d, e, f) {
		return {id: a, description: b, dateAdded: c, thumbnail: d, fullsize: e, download: f};
	});

var _user$project$Data_ImageData$images = {
	ctor: '::',
	_0: {
		id: 1,
		description: 'an image',
		dateAdded: A3(_elm_community$elm_time$Time_Date$date, 2017, 11, 1),
		thumbnail: 'http://placehold.it/300x200',
		fullsize: 'http://placehold.it/900x600',
		download: 'http://placehold.it/3600x2400'
	},
	_1: {
		ctor: '::',
		_0: {
			id: 2,
			description: 'an image 2',
			dateAdded: A3(_elm_community$elm_time$Time_Date$date, 2017, 11, 2),
			thumbnail: 'http://placehold.it/300x400/efefef',
			fullsize: 'http://placehold.it/900x1200/efefef',
			download: 'http://placehold.it/3600x4800/efefef'
		},
		_1: {
			ctor: '::',
			_0: {
				id: 3,
				description: 'an image 3',
				dateAdded: A3(_elm_community$elm_time$Time_Date$date, 2017, 11, 3),
				thumbnail: 'http://placehold.it/300x700/ff2233',
				fullsize: 'http://placehold.it/900x2100/ff2233',
				download: 'http://placehold.it/3600x8400/ff2233'
			},
			_1: {
				ctor: '::',
				_0: {
...
var _user$project$Images_CardView$imageCard = function (image) {
...
var _user$project$Images_ImageView$imageDetail = function (image) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Models$initialModel = function (route) {
	return {images: _user$project$Data_ImageData$images, route: route};
};
var _user$project$Models$Model = F2(
	function (a, b) {
		return {images: a, route: b};
	});
...
var _user$project$View$getImage = function (id) {
	return _elm_lang$core$List$head(
		A2(
			...
			_user$project$Data_ImageData$images));
};
var _user$project$View$notFoundView = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Image Not Found'),
		_1: {ctor: '[]'}
	});
var _user$project$View$homeView = function (model) {
	return A2(
		...
		A2(_elm_lang$core$List$map, _user$project$Images_CardView$imageCard, model.images));
};
var _user$project$View$imageView = function (model) {
	imageView:
	while (true) {
		var _v0 = model;
		model = _v0;
...
var _user$project$View$page = function (model) {
	...
	switch (_p0.ctor) {
		case 'ImageRoute':
			var _p1 = _user$project$View$getImage(_p0._0);
			if (_p1.ctor === 'Just') {
				return _user$project$Images_ImageView$imageDetail(_p1._0);
			} else {
